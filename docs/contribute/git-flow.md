...
```bash
git remote add upstream  https://github.com/hadenlabs/terraform-aws-ec2-instance.git
```

Now your **upstream** points to **hadenlabs/terraform-aws-ec2-instance**.
...
git fetch upstream # assuming upstream is hadenlabs/terraform-aws-ec2-instance
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/terraform-aws-ec2-instance/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
